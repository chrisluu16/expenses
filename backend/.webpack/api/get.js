...
exports.getCategoryExpenses = undefined;
...
var getCategoryExpenses = exports.getCategoryExpenses = function () {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 4:
                        ...
                        if (result.Item) {
                            callback(null, (0, _responseLibs.success)(result.Item));
                        } else {
                            callback(null, (0, _responseLibs.failure)({ status: false, error: "No expenses" }));
                        }
                        _context.next = 13;
                        break;
                    ...
                    case 9:
                        ...
                        callback(null, (0, _responseLibs.failure)({ status: false }));
    ...
    return function getCategoryExpenses(_x, _x2, _x3) {
...
var _responseLibs = __webpack_require__(5);
